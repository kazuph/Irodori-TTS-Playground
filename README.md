...
| Model | Sample Text | Generation Time | Audio Duration | RTF |
|-------|------------|----------------|---------------|-----|
| Normal | "おはようございます。今日もいい天気ですね。" (18 chars) | 1.43s | 4.00s | 2.81x |
| Normal | "その森には、古い言い伝えがありました。月が最も高く昇る夜、静かに耳を澄ませば..." (87 chars) | 1.48s | 26.80s | 18.43x |
| VoiceDesign | "おはようございます。今日もいい天気ですね。" (18 chars) | 1.51s | 4.68s | 3.12x |
| VoiceDesign | "その森には、古い言い伝えがありました。月が最も高く昇る夜、静かに耳を澄ませば..." (87 chars) | 1.49s | 25.72s | 17.47x |

- **RTF** (Real-Time Factor) = Audio Duration / Generation Time（高いほど高速。1.0x = リアルタイム）
- 長文ほど RTF が大幅に向上（短文 ~3x → 長文 ~18x）
